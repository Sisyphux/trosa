...
>
> 审计基线：2026-09-12 16:28 CST 发布后运行态（commit `0a25827`，release
> `auto-20260912082853-0a25827`；包含功能收敛 commit `7535b79`）。本轮已把正式运行契约、入口安全门、健康响应和开发入口
...
5. **ECS 正式契约与迁移账本已完成本轮验收**：当前 release 为
   `auto-20260912082853-0a25827`，公网四字段健康门通过，受控 `verify_schema` 确认
...
- 已确认事实：单体形态、无蓝图158路由、单向无环依赖、trosa_domain唯一写入通道、
  ...
  ECS 当前 release 为 `auto-20260912082853-0a25827`，公网正式契约通过，生产库
