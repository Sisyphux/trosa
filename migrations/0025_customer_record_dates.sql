-- Customer-facing dates are projections of formal Interaction and Task facts.
-- Keep their modern names explicit so product callers never need the old
-- ``last_contact`` / ``next_follow_up`` compatibility vocabulary.
BEGIN;
