...
REQUIRED_COLUMNS = (
    ...
    ("trosa.customer_details", "source"),
    ("trosa.customer_details", "source_detail"),
    ("trosa.customer_records", "last_interaction_on"),
    ("trosa.customer_records", "next_task_on"),
    ("trosa.customer_records", "pinned_at"),
    ("trosa.customer_records", "source"),
    ("trosa.customer_records", "source_detail"),
    ...
    ("trosa.agent_prospect_profiles", "transport_json"),
    ("trosa.business_exclusions", "source_id"),
    ("trosa.business_exclusions", "canonical_name"),
    ("trosa.business_exclusions", "match_policy"),
    ("trosa.business_exclusions", "is_active"),
